...
| [`orchestrator-two-way-messaging`](../prompt-packs/orchestrator-two-way-messaging/) | BKL-001, BKL-002, MSG-003 through MSG-007 | MSG-002 was independently accepted with a valid sealed, critical-tier review at `570a787`; BKL-002 remains in review pending HARD-007, claimed live-executor adapters, and the owning phase gate. MSG-005 has an accepted repair on an unmerged branch and requires integration/review on current master. MSG-001 was force-accepted with a sealed, explicit operator override after independent focused verification. |
| [`delegation-communication-reliability`](../prompt-packs/delegation-communication-reliability/) | PROC-001 through PROC-005, MAINT-003 through MAINT-006 | PROC-001 is accepted. PROC-002 has its focused control-intent repair integrated and passing substantive review, but remains in review until the review-completion collection defect is corrected. PROC-003 and PROC-004 are implemented with focused invariant/installed evidence and are in review pending the pack gate and remaining recovery matrix. MAINT-003 repairs terminal-completion inbox expectations; MAINT-004 repairs review ticket identity; MAINT-005 closes remaining review-launch and completion-template enforcement gaps; MAINT-006 repairs historical host-index verification so valid review gates are not blocked by obsolete evidence. |
...
| [`comparative-benchmark-scoring-corrections`](../prompt-packs/comparative-benchmark-scoring-corrections/) | BENCH-CORR-001 through BENCH-CORR-010; BENCH-OPS-001 through BENCH-OPS-003 | Rebased to 0.7.9. The corrected scoring implementation is under review and the new operator-experience slice is integrated: two stable panes, visible provider output, durable live-review servers, and the compact suite. Calibration, migration, real-tmux installed acceptance, and the independent gates remain open. The benchmark stays built in under DEC-009. |
| [`benchmark-real-host-release-candidate-gate`](../prompt-packs/benchmark-real-host-release-candidate-gate/) | Review-only; no backlog ownership | Codex handoff for the remaining authenticated tmux/provider/browser/human-review evidence. It may verify or reject BENCH-CORR-GATE and BENCH-OPS-GATE, but it may not redefine scoring or claim completed evidence without the bundled 100-point mandatory evaluation. |
...
| PROC-002 | P0 | Critical | in-review | Integrated/pushed repair `7fdf69d` adds installed duplicate, malformed, stale, and post-exit control-intent coverage; focused installed bridge checks (3 passed), release audit, and ordinary pack validation pass. Valid sealed review `proc-002-review-r4-20260802` found no substantive defect, but recorded `partial` for a future host-owned disposition; later re-reviews exposed a completion-collection defect (including a false base-revision mismatch despite exact recorded launch/base/head SHA). Correct that lifecycle review contract, then re-run the phase gate. | [`delegation-communication-reliability`](../prompt-packs/delegation-communication-reliability/phase-0/tickets/PROC-002-control-handshake.md) |
...
| MSG-005 | P1 | Critical | in-review | Accepted sealed repair `messaging-msg-005-ack-action-repair-r4-20260801` commits `ad6b85d` on `impl/msg-005-ack-action-repair-r4`, enforcing acknowledgement-before-action append with focused invariant evidence. That branch is not merged into master; integrate and independently review it on the current source before acceptance is recorded here. | [Messaging design](ORCHESTRATOR_TWO_WAY_MESSAGING_DESIGN.md#failure-and-restart-behavior) |
...
| REL-009 | P1 | High | in-review | Completed sealed implementation `rel-009-jenkins-post-commit-r2-20260802` produced `0eec5c1` on `impl/rel-009-jenkins-post-commit-r2-20260802`: opt-in/reversible hook install, exact local-master revision correlation, asynchronous failure handling, and repository-only distribution boundary all passed. The commit is not merged into master and still needs independent review/integration. | [Jenkins CI/CD boundary](JENKINS_CI.md) |
...
| ID | Priority | Risk | State | Work and exit evidence | Reference |
|---|---|---:|---|---|---|
| BENCH-CORR-001 | P0 | Critical | in-review | Corrected v2 machine-readable scoring contract is implemented, reconciles to exactly 100 points, preserves v1 semantics, and has local contract/calibration evidence. Independent real-host gate acceptance remains open. | [Ticket](../prompt-packs/comparative-benchmark-scoring-corrections/phase-0/tickets/BENCH-CORR-001-scoring-contract.md) |
| BENCH-CORR-010 | P1 | Medium | in-review | Efficiency policy is implemented with separate quality, eligibility, timing, token, billed/estimated/subscription cost, and winner semantics. Real subscription evidence and independent acceptance remain open. | [Ticket](../prompt-packs/comparative-benchmark-scoring-corrections/phase-0/tickets/BENCH-CORR-010-efficiency-policy.md) |
| BENCH-CORR-002 | P0 | Critical | in-review | Explicit per-check weighted v2 scoring, strict missing/unknown/over-award rejection, versioned receipts, and v1 compatibility are implemented and locally validated. Independent installed acceptance remains open. | [Ticket](../prompt-packs/comparative-benchmark-scoring-corrections/phase-1/tickets/BENCH-CORR-002-weighted-scorer.md) |
| BENCH-CORR-003 | P0 | High | in-review | Corrected functional, validation, ordering, filter/sort/export, determinism, non-mutation, malformed-load, and scale checks are implemented with weighted traceability and calibration evidence. | [Ticket](../prompt-packs/comparative-benchmark-scoring-corrections/phase-1/tickets/BENCH-CORR-003-functional-validation-evals.md) |
| BENCH-CORR-004 | P0 | High | in-review | Deterministic browser, download, empty/invalid, keyboard/focus, responsive, reduced-motion, console, and accessibility evidence is implemented. Real installed browser/live-app acceptance remains open. | [Ticket](../prompt-packs/comparative-benchmark-scoring-corrections/phase-1/tickets/BENCH-CORR-004-browser-accessibility-evals.md) |
| BENCH-CORR-005 | P1 | High | in-review | Public regression scoring and duplicate-credit semantics are frozen in the v2 contract and locally calibrated. Independent gate review remains open. | [Ticket](../prompt-packs/comparative-benchmark-scoring-corrections/phase-1/tickets/BENCH-CORR-005-public-scoring.md) |
| BENCH-CORR-006 | P1 | High | in-review | Blinded live review, rating anchors, blocking-defect handling, immutable reviewer submissions, minimum-reviewer policy, and human-time reporting are implemented. Real independent reviews remain open. | [Ticket](../prompt-packs/comparative-benchmark-scoring-corrections/phase-2/tickets/BENCH-CORR-006-human-review.md) |
| BENCH-CORR-007 | P0 | Critical | in-review | Golden, partial, mutation, invalid-guardrail, harness-failure, visual, and compact timing calibration are implemented with source/install parity. Real-provider timing remains open. | [Ticket](../prompt-packs/comparative-benchmark-scoring-corrections/phase-2/tickets/BENCH-CORR-007-calibration-mutations.md) |
| BENCH-CORR-008 | P1 | High | in-review | Contract-derived scoring/docs/schema behavior, exact repository/installed suite mirrors, and release drift checks are implemented while preserving the built-in/plugin boundary. | [Ticket](../prompt-packs/comparative-benchmark-scoring-corrections/phase-2/tickets/BENCH-CORR-008-single-source-docs.md) |
| BENCH-CORR-009 | P1 | High | in-review | Mixed-version rejection, sealed scorer/evaluator/fixture/runtime/policy identities, historical receipt preservation, and additive lineage rules are implemented. Independent migration/publication review remains open. | [Ticket](../prompt-packs/comparative-benchmark-scoring-corrections/phase-3/tickets/BENCH-CORR-009-version-migration.md) |
| BENCH-OPS-001 | P0 | Critical | in-review | Integrated the same-window two-pane runner with stable run/arm bindings, visible provider stdout/stderr, atomic result handoff, capacity preflight, stale-pane ownership checks, and provider process-group cancellation. Focused invariants pass; installed real-tmux gate evidence remains open. | [Ticket](../prompt-packs/comparative-benchmark-scoring-corrections/phase-4/tickets/BENCH-OPS-001-observable-paired-panes.md) |
| BENCH-OPS-002 | P0 | Critical | in-review | Integrated per-arm live servers, readiness/status/start/stop lifecycle, pane log/URL display, blinded live URLs, restart refresh, preservation-first cleanup, and partial failure records. Installed browser/human-review gate evidence remains open. | [Ticket](../prompt-packs/comparative-benchmark-scoring-corrections/phase-4/tickets/BENCH-OPS-002-live-review-lifecycle.md) |
| BENCH-OPS-003 | P1 | High | in-review | Added `priority-picker-fast-v1` with one 150-second model phase, corrected granular scoring, visual capture from the live app, subscription-first executors, an exact packaged mirror, and deterministic paired synthetic wall-budget calibration. Real subscription timing and independent installed tmux/browser acceptance remain open. | [Ticket](../prompt-packs/comparative-benchmark-scoring-corrections/phase-4/tickets/BENCH-OPS-003-fast-benchmark-suite.md) |

The review-only `BENCH-CORR-GATE` follows BENCH-CORR-006, BENCH-CORR-009, and BENCH-CORR-010 and must separately accept or reject corrected scoring for development, internal, and publication use. `BENCH-OPS-GATE` separately requires a real installed tmux/live-application journey for the operator-experience and compact-suite slice.
...
| MAINT-003 | completed | Terminal completed children import/replay once as sealed immutable evidence, while only explicit `--keep-alive` preserves `idle_reusable`. Accepted sealed review `maint-003-review-r2-20260802` independently passed terminal/keep-alive installed journeys, stale/missing-assignment invariants, audit, and ordinary pack validation. |
| MAINT-004 | completed | Immutable review ticket-identity binding now enforces explicit-ticket agreement or contracted omission without weakening session, pack, or revision checks. Accepted sealed re-review `maint-004-review-r3-20260802` independently passed invariant, installed omitted/mismatched review journeys, audit, and pack validation. |
| MAINT-005 | completed | Generated completion command templates and mirrored operator guidance now require schema-valid `argv`/absolute `cwd`/integer `exit_code`/`receipt` objects, while typed criterion evidence and rejection of `commands[].evidence` remain enforced. Accepted sealed review `maint-005-review-r4-20260802` independently passed focused installed collection, audit, and pack validation. |
| MAINT-006 | completed | Historical host evidence remains preserved/excluded while current integrity failures stay fail-closed. Accepted sealed final review `maint-006-review-r4-20260802` combined focused/installed/audit/pack evidence with writable-host rebuild (17 errors, 226 quarantined) and full verification (`valid:false`). |
| MAINT-007 | completed | Immutable v2 index-integrity authority and explicit scoped `index verify --review` preserve historic invalid evidence without mutation. Accepted sealed review `maint-007c-review-r2-20260802` has a valid collection, receipt, and closed session; installed 0.7.9 keeps global verification false for 17 integrity errors while that reviewed scope is valid. |
| PROC-001 | completed | Receipt-bound authoritative launch preflight accepted after sealed re-review `proc-001-review-r4-20260802`: exact-worktree preflight, accepted/rejected/missing/stale prerequisite matrix, installed public launch journey, release audit, and ordinary pack validation all passed. The prior `--verify-checksums` review finding was invalid because `MANIFEST.sha256` is an optional ignored transfer sidecar. |
