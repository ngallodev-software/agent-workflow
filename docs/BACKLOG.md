...
| MSG-005 | P1 | Critical | ready | BKL-001, MSG-001, and MSG-002 are accepted. Reconstruct delivery after supervisor/orchestrator restart, missed or duplicate signals, corrupt cursors, and every cursor/inbox crash window without duplicate semantic effects. | [Messaging design](ORCHESTRATOR_TWO_WAY_MESSAGING_DESIGN.md#failure-and-restart-behavior) |
