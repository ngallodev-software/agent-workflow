...
| [`orchestrator-two-way-messaging`](../prompt-packs/orchestrator-two-way-messaging/) | BKL-001, BKL-002, MSG-002 through MSG-007 | BKL-002 now has an opt-in cooperative file adapter, durable delivery outcomes, and installed fixture evidence; it remains in review pending HARD-007, claimed live-executor adapters, and the owning phase gate. MSG-001 was force-accepted with a sealed, explicit operator override after independent focused verification. |
...
|---|---|---:|---|---|---|
| MSG-002 | P0 | Critical | in-review | Integrated foreground orchestrator watch now provides single-writer ownership, a shared hashed tmux wake hint with periodic replay fallback, bounded round-robin fairness, append-before-cursor fan-in, installed recovery coverage for lost/duplicate hints, and focused fairness/lease/shutdown-resume invariants. Independent review and shared acceptance remain open. | [Messaging design](ORCHESTRATOR_TWO_WAY_MESSAGING_DESIGN.md#use-one-shared-wake-channel) |
