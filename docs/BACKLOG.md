...
|---|---|---:|---|---|---|
| MSG-002 | P0 | Critical | in-review | Integrated foreground orchestrator watch now provides single-writer ownership, a shared hashed tmux wake hint with periodic replay fallback, bounded round-robin fairness, and append-before-cursor fan-in. Independent review and shared installed-product acceptance remain open. | [Messaging design](ORCHESTRATOR_TWO_WAY_MESSAGING_DESIGN.md#use-one-shared-wake-channel) |
