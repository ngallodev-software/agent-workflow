...
| [`codex-luna-effort-policy`](../prompt-packs/codex-luna-effort-policy/) | POL-001 | Ready; enforces Luna-only automatic Codex selection with bounded low/medium/high effort and explicit launch evidence. |
