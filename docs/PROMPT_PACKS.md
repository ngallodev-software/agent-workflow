...
| [`orchestrator-two-way-messaging`](../prompt-packs/orchestrator-two-way-messaging/) | BKL-001, BKL-002, MSG-002 through MSG-007 | MSG-001 is force-accepted with a sealed operator override; later phases remain dependency-gated. |
