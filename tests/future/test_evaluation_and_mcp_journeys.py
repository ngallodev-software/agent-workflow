...
def test_mcp_003_mutation_requires_authenticated_principal_and_preserves_read_only_tools() -> None:
    ...
    # principals are recorded immutably, existing capability/catalog/run-command resources
    # still work, and MCP launch preserves the CLI launch-contract v2 command bindings.
