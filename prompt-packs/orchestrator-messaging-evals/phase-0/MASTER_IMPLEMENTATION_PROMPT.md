...
Research and freeze the local-first control contract. Produce evidence and stop
before code if the contract would require a service or executor assumption.
