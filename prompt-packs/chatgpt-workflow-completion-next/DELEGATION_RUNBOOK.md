...
This runbook applies to the full completion sequence in the pack README.
Do not parallelize dependent tickets. Keep implementation and independent
review in separate worktrees and separate agent sessions. At the end, run the
critical-review/fix loop described in `CHATGPT_HANDOFF_PROMPT.md` even if all
ticket-level reviews passed.
