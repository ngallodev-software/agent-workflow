# Phase 1 — preventative isolation and sensitive content master implementation prompt
...
Coordinate only these tickets: `HARD-003`, `HARD-006`. Respect manifest dependencies. Dependency-free tickets may run concurrently in isolated worktrees. Do not merge by taking one agent's branch wholesale; inspect each diff and integrate the smallest compatible changes.
