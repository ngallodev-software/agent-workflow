# Phase 0 — config and executor trust master implementation prompt
...
Coordinate only these tickets: `HARD-008`. Respect manifest dependencies. Dependency-free tickets may run concurrently in isolated worktrees. Do not merge by taking one agent's branch wholesale; inspect each diff and integrate the smallest compatible changes.
