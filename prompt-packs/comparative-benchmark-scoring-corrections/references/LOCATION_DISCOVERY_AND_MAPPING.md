...
| Benchmark invariants | `tests/invariants/test_comparative_benchmark_contracts.py`, `test_comparative_benchmark_operating_policy.py`, and `tests/acceptance/test_comparative_benchmark_journey.py` | Compact invariants | Cover arithmetic, versioning, and policy in compact matrices; cover dispatch and operator behavior through the installed journey. |
