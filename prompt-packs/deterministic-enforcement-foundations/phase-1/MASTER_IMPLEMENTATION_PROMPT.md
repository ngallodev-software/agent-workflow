# Phase 1 — immutable authority and MCP read boundary master implementation prompt
...
Coordinate only these tickets: `HARD-004`, `HARD-005`. Respect manifest dependencies. Dependency-free tickets may run concurrently in isolated worktrees. Do not merge by taking one agent's branch wholesale; inspect each diff and integrate the smallest compatible changes.
