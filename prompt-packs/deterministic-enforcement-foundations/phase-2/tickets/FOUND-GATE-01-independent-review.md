# FOUND-GATE-01 — independent deterministic-foundation review
...
- `HARD-001` accepted and integrated.
- `HARD-002` accepted and integrated.
- `HARD-004` accepted and integrated.
- `HARD-005` accepted and integrated.
...
- Verify every repository-owned subprocess call is either migrated or has a documented interactive exemption.
- Attempt pack/native-job/schema/MCP symlink and replacement attacks against the integrated tree.
- Mutate projections after launch and prove runner, lifecycle, and evaluation authority does not change.
- Confirm MCP default responses contain no durable message bodies or raw local paths.
