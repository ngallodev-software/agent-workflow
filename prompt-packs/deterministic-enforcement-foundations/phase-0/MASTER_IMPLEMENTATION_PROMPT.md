# Phase 0 — bounded execution and artifact integrity master implementation prompt
...
Coordinate only these tickets: `HARD-001`, `HARD-002`. Respect manifest dependencies. Dependency-free tickets may run concurrently in isolated worktrees. Do not merge by taking one agent's branch wholesale; inspect each diff and integrate the smallest compatible changes.
