# Phase 1 — public-preview decision gate master implementation prompt
...
Coordinate only these tickets: `REL-004`. Respect manifest dependencies. Dependency-free tickets may run concurrently in isolated worktrees. Do not merge by taking one agent's branch wholesale; inspect each diff and integrate the smallest compatible changes.
