...
Additionally inventory every CLI handler and existing MCP function relevant to
run listing, status, messages, receipts, and pack validation; propose the minimum
shared service boundary without editing production source.
