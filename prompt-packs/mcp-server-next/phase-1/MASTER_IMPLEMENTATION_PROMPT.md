...
Coordinate a narrow MCP-0 seam extraction. Preserve lifecycle semantics and keep
MCP/CLI adapters thin over shared typed services.
...
Do not advance unless the independent reviewer accepts root containment,
redaction, stable errors, compatibility, and shared-service evidence.
