...
Coordinate completion of the optional read-only local stdio MCP server using
public stable SDK APIs and accepted Phase 1 services.
...
Do not advance to mutation or HTTP. Require independent security/conformance
acceptance and preserve tool versions and command evidence.
