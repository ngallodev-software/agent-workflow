...
Additionally audit the current MCP scaffold against accepted Phase 1 services,
the pinned SDK public API, package extras/entry point, and available conformance
tools. Record gaps before implementation.
