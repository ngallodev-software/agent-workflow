# Phase 0 — durable fan in foundations master implementation prompt
...
Coordinate only these tickets: `BKL-001`, `MSG-001`. Respect manifest dependencies and ticket-specific `HARD-*` prerequisites. Dependency-free tickets may run concurrently in isolated worktrees. Inspect and integrate the smallest compatible diffs rather than replacing shared files wholesale.
