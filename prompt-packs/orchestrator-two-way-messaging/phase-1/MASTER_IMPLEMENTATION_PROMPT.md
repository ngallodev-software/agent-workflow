# Phase 1 — supervisor and late delivery master implementation prompt
...
Coordinate only these tickets: `MSG-002`, `BKL-002`. Respect manifest dependencies and ticket-specific `HARD-*` prerequisites. Dependency-free tickets may run concurrently in isolated worktrees. Inspect and integrate the smallest compatible diffs rather than replacing shared files wholesale.
