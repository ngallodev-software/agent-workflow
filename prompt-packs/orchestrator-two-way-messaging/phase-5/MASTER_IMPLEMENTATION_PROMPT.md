# Phase 5 — independent messaging gate master implementation prompt
...
Coordinate only these tickets: `MSG-GATE-01`. Respect manifest dependencies and ticket-specific `HARD-*` prerequisites. Dependency-free tickets may run concurrently in isolated worktrees. Inspect and integrate the smallest compatible diffs rather than replacing shared files wholesale.
