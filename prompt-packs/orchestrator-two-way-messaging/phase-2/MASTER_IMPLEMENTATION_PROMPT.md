# Phase 2 — safe wake and restart reconstruction master implementation prompt
...
Coordinate only these tickets: `MSG-003`, `MSG-005`. Respect manifest dependencies and ticket-specific `HARD-*` prerequisites. Dependency-free tickets may run concurrently in isolated worktrees. Inspect and integrate the smallest compatible diffs rather than replacing shared files wholesale.
