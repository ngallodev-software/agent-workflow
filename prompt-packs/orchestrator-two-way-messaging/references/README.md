...
- [`docs/ORCHESTRATOR_TWO_WAY_MESSAGING_DESIGN.md`](../../../docs/ORCHESTRATOR_TWO_WAY_MESSAGING_DESIGN.md) — complete architecture, authority, security, failure, and acceptance design.
