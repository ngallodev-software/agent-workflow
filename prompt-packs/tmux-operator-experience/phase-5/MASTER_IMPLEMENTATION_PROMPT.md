...
Coordinate an independent review of the optional UI pane role and sidebar.

## Objective

Accept only if live layout stress and uninstall evidence prove zero corruption of capacity, geometry, pane identity, or global tmux configuration.
