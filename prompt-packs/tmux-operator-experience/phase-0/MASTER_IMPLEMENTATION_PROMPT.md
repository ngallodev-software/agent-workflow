...
Act as phase coordinator for the authoritative tmux operator read model.

## Objective

Implement TMUXUI-001 only after accepted PROC-006 evidence. Establish the bounded snapshot contract, attention ranking, stable pane join, degraded behavior, and public JSON/human output.
