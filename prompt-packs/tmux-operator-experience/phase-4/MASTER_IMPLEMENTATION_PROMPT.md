...
Execute the optional embedded-sidebar ticket only after explicit maintainer authorization.

## Objective

Introduce a first-class UI pane role and prove that an opt-in sidebar cannot affect agent capacity, deterministic layout, orchestrator placement, or stable run identity.
