...
Close installed/live/security/documentation evidence, then obtain an independent core gate decision.

## Objective

Prove the core popup/status/dashboard feature as an installed product. Do not include or authorize the embedded sidebar.
