...
Coordinate lifecycle-aware actions, the dedicated dashboard, and event-hint refresh.

## Objective

Add persistent operator capability while preserving application authority, pane identity, layout capacity, and evidence.
