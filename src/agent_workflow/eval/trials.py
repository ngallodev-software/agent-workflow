...
def extract_trial(run_dir: Path) -> dict[str, Any]:
    ...
    result = {
        ...
        "verdict": verdict,
        "provider": provider.get("executor"),
        "source_revision": provenance.get("source_revision"),
        "pack_manifest_sha256": provenance.get("pack_manifest_sha256"),
        ...
        "fixture_sha256": field("fixture_sha256"),
        ...
        "reference_sha256": field("reference_sha256"),
